-- Giaogui Hub (Standalone)
-- Author: Giaogui
-- Bundled UI + Notify libraries
-- Load with:
-- loadstring(game:HttpGet("https://raw.githubusercontent.com/Giaogui/GiaoguiHub/main/loader.lua"))()
...
-- === GIAOGUI NOTIFY (FROM BOREDLIB) ===
-- Credits to BoredStuff :3
...
-- GiaoguiNotify bundled (no return)


-- === GIAOGUI UI (FROM DRAYLIB) ===
-- Credits to DrRay, Original thread: https://raw.githubusercontent.com/AZYsGithub/DrRay-UI-Library/main/DrRay.lua
...
local function require(Module:ModuleScript)
    ...
    -- GiaoguiUI bundled (no return)_REQUIRE(Module);
end
...
-- === BOOTSTRAP UI ===
print("[Giaogui] Bootstrapping UI")

-- Expect GiaoguiNotify and GiaoguiUI tables to exist from bundled libs

local Window = GiaoguiUI:CreateWindow({
    Title = "Giaogui Hub",
    SubTitle = "Standalone Build",
...
MainTab:CreateButton({
    ...
    Callback = function()
        if GiaoguiNotify and GiaoguiNotify.prompt then
            GiaoguiNotify.prompt("Giaogui Hub", "Standalone build working!", 3)
        end
    end
})

print("[Giaogui] Loaded successfully")
